          ...
          {activeTab === 'overview' && (
            <div className="grid lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
              <div className="lg:col-span-2 space-y-8">
                {/* Simplified Overview Cards as per previous logic */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                   ...
                   <StatCard label="Leaks Blocked" value="14" icon="🚫" />
              ...
              <div className="space-y-8">
                <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl text-center">
                   ...
                   <button className="w-full py-5 rounded-2xl font-black text-xs uppercase tracking-widest transition-all bg-white text-slate-900 hover:bg-emerald-400">Download Trust Badge</button>
                </div>
              </div>
            </div>
          )}
